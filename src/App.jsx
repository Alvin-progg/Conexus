    ...
    <div style={{ fontFamily: "'Syne', sans-serif", background: "#0e1a0e", color: "#f0f0e8", minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .project-card {
          border: 1px solid rgba(184,255,87,0.16);
          background: radial-gradient(circle at top right, rgba(184,255,87,0.12), rgba(13,22,13,0.86) 46%);
          border-radius: 18px;
          padding: 20px;
          min-height: 180px;
        }
        ...
        @media (max-width: 768px) {
          ...
          .projects-grid .project-card:nth-child(1),
          .projects-grid .project-card:nth-child(2),
          .projects-grid .project-card:nth-child(3) { grid-column: auto; grid-row: auto; }
      ...
      <main className="content-wrap">
        ...
        <section id="projects" className="projects-section" ref={projectsRef}>
          <div className={`section-head fade-up${projectsIn ? " visible" : ""}`}>
            ...
            <button className="btn-outline">View All Work</button>
          </div>
          <div className="projects-grid">
            {PROJECTS.map((project, index) => (
              <article key={project.name} className={`project-card fade-up d${(index % 3) + 1}${projectsIn ? " visible" : ""}`}>
